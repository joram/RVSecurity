...
class KasaPowerStrip:
    ...
    def discover_power_strips_sync(cls, scan_all_networks=False, timeout=30):
        ...
        Uses basic kasa discovery without complex network scanning.
        ...
        try:
            ...
            return temp_instance._run_async(simple_discover())
